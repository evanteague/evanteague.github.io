...
function AppSidebar() {
  const getWorks$1 = useServerFn(getWorks);
  const getProjects$1 = useServerFn(getProjects);
  ...
  return /* @__PURE__ */ jsx(Sidebar, { children: /* @__PURE__ */ jsxs(SidebarContent, { children: [
    /* @__PURE__ */ jsxs(SidebarGroup, { children: [
      /* @__PURE__ */ jsx(SidebarGroupLabel, { children: "Work Experience" }),
      /* @__PURE__ */ jsx(SidebarGroupContent, { children: /* @__PURE__ */ jsx(SidebarMenu, { children: works?.map((item) => /* @__PURE__ */ jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsx(SidebarMenuButton, { asChild: true, children: /* @__PURE__ */ jsx("a", { href: `#${item.title}`, children: /* @__PURE__ */ jsx("span", { children: item.title }) }) }) }, item.title)) }) })
    ] }),
    /* @__PURE__ */ jsxs(SidebarGroup, { children: [
      /* @__PURE__ */ jsx(SidebarGroupLabel, { children: "Projects" }),
      /* @__PURE__ */ jsx(SidebarGroupContent, { children: /* @__PURE__ */ jsx(SidebarMenu, { children: projects?.map((item) => /* @__PURE__ */ jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsx(SidebarMenuButton, { asChild: true, children: /* @__PURE__ */ jsx("a", { href: `#${item.title}`, children: /* @__PURE__ */ jsx("span", { children: item.title }) }) }) }, item.title)) }) })
    ] })
  ] }) });
}
function Layout({ children }) {
  ...
  return /* @__PURE__ */ jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxs(SidebarProvider, { children: [
    ...
    /* @__PURE__ */ jsx("main", { className: "w-full", children })
  ] }) });
}
