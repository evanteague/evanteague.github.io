...
async function loadVirtualModule(id) {
  switch (id) {
    case VIRTUAL_MODULES.startManifest:
      return await import("./assets/_tanstack-start-manifest_v-Zh2MwGQa.js");
...
const manifest = { "50919c5e13a9191f93cc0684c4c7854948bc4aaa151654b6f916b6a1ab73e4b5": {
  functionName: "getWorks_createServerFn_handler",
  importer: () => import("./assets/requests-Cq9pckJH.js")
}, "273abfaf4e2a06a1895b57d4bd9b8984cb1f9a4030f1472bf2c1b6827c51c839": {
...
function createStartHandler(cb) {
  ...
  const getEntries = async () => {
    if (routerEntry === null) {
      routerEntry = await import("./assets/router-BxkAHa_W.js").then((n) => n.r);
    }
    if (startEntry === null) {
